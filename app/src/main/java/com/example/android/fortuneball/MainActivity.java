package com.example.android.fortuneball;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFortuneBallImage = (ImageView) findViewById(R.id.fortuneImage);
        ...
        mGenerateFortuneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                YoYo.with(Techniques.Swing).duration(500).playOn(mFortuneBallImage);
